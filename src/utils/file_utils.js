        ...
        if (is_forward) {
            ...
            for (let i = 0; i < lines_number; i++) {
                lanes.push(new Lane(
                    ...
                    Math.PI,
                    startX + shift + way_multiplier * (  i * logic_lane_width) + shiftX,
                    startY + shiftY,
                    finishX + shift + way_multiplier * ( i * logic_lane_width) + shiftX,
                    finishY + shiftY
                ));
            }
        }
        ...
        if (is_forward) {
            ...
            for (let i = 0; i < lines_number; i++) {
                lanes.push(new Lane(
                    ...
                    - Math.PI /2,
                    startX + shiftX,
                    startY - way_multiplier * (i * logic_lane_width + logic_lane_width / 2) + shiftY,
                    finishX + shiftX,
                    finishY - way_multiplier * (i * logic_lane_width + logic_lane_width / 2) + shiftY
                ));
            }
        }
    }
